...
#define STRING_SPLASH_LINE1 "FP3D.sk" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Juraj Sarissky je boh"       // will be shown during bootup in line 2
